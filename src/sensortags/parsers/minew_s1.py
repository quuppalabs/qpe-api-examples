...
FIXME: This qpe output is not recognized by the parser:
0201060303e1ff1216e1ffa1 03 64000affe200f83182ab3f23ac
most likely a connection packet as the flag data type byte is
0x03 instead of 0x01. At some point this should be handled and
parsed or discarded....
"""
